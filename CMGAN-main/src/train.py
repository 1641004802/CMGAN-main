...
parser.add_argument("--epochs", type=int, default=NUM_EPOCHS, help="number of epochs of training")#120
...
parser.add_argument("--cut_len", type=int, default=16000*2, help="cut length, default is 2 seconds in denoise "
                                                                 "and dereverberation")
parser.add_argument("--data_dir", type=str, default='/achive/sbliu/',help="dir of VCTK+DEMAND dataset")
parser.add_argument("--save_model_dir", type=str, default='./saved_model',help="dir of saved model")
...
args.device=torch.cuda.device(local_rank)
...
class Trainer:
    def __init__(self, train_ds, test_ds):
        ...
        #self.model = nn.parallel.DataParallel(self.model.to(device),device_ids=None,output_device=None)
        #---------------------
        #修改2()-----------
